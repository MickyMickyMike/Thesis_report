...
Samotné stahování souborů je další samostatný podproblém. Zde by měla být implementována logika selekce pouze HTML a js souborů, ostatní soubory pro funkčnost cleansetu nejsou důležité. Je tedy možné tuto selekci provádět přímo při stahování souborů a stahovat pouze potřebné, nebo vždy pro zdanou adresu stáhnout všechny soubory a výběr provézt následně.

\subsection{Parsování webových stránek}
\subsection{Fiddler}

\section{Nahrání získaného obsahu do databáze}
Dalším krokem bude přesun získaného obsahu do samotné databáze cleansetu. 
