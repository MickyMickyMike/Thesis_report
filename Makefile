...
COVER_IMAGES=cvut-logo-bw.pdf cvut-logo-w.pdf
...
TEMPLATE_ZIP=$(JUSTCOMPILE_TEMPLATE_TEX) FITthesis.cls iso690.bst csn690.bst mybibliographyfile.bib ref.bib cvut-logo-bw.pdf gnuplot-bw.pdf gnuplot-col.pdf DP_Priklad.pdf MastersThesis_example.pdf $(TEMPLATE_GENERATED_TEX) $(TEMPLATE_README_EN) $(TEMPLATE_README_CS)
